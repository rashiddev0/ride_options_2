                ...
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: PinCodeTextField(
                            ...
                            pinTheme: PinTheme(
                              ...
                              activeFillColor: MediaQuery.of(context).platformBrightness == Brightness.dark ? const Color(0xff242424) : secondaryColor,
                      ...
                      Padding(
                        padding:
                        EdgeInsets.only(top: 37.5.h, left: 55.w, right: 55.w),
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
