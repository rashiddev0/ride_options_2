...
class _LocationMapScreenState extends State<LocationMapScreen>
                  ...
                  children: [
                    Positioned.fill(
                      ...
                      child: GoogleMap(
                        ...
                        polylines:
                            polyLines.isEmpty ? {} : <Polyline>{polyLines.last},
  ...
  Future<void> setPolyLines() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        PointLatLng(
            homeBloc.dropLocationMap["lat"], homeBloc.dropLocationMap["lng"]));
    if (result.status == "OK") {
      ...
      int i = 0;
      myTimer = Timer.periodic(const Duration(microseconds: 8000), (timer) {
